...
export async function sendVerificationRequest(params: any) {
    ...
    const res = await fetch("https://api.forwardemail.net/v1/emails", {
        ...
        body: JSON.stringify({
            ...
            }DBackup Partner Panele Giriş Yap`,
            html: html({ url, host }),
            text: text({ url, host }),
...
<!--[if !mso]>-->
<link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@700&amp;family=Roboto:wght@400&amp;display=swap" rel="stylesheet" type="text/css" />
<!--<![endif]-->
<!--[if mso]>
<xml>
